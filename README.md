...
| **Rebuttal Guidance** | 基于条件说服模型，识别审稿人心态（X）、匹配 rebuttal 策略（Y），为每条 Weakness/Question 生成可执行的回应指导，含 concern 分类、语气建议、证据指针与完整性检查 | [使用技能](skills/rebuttal-guidance/SKILL.md) |
